...
namespace Chat.Services
{
    public class ChatService : IChatService
    {
        ...
        public async Task CreateConnection()
        {
            ...
            var result = await httpClient.GetStringAsync("https://eksteinfunctionapp.azurewebsites.net/api/GetSignalRInfo");

            var info = JsonConvert.DeserializeObject<chat.Models.ConnectionInfo>(result);
        ...
        public async Task SendMessage(Message message)
        {
            ...
            await httpClient.PostAsync("https://eksteinfunctionapp.azurewebsites.net/api/messages", content);
        }
...
//            var info = JsonConvert.DeserializeObject<chat.Models.ConnectionInfo>
//            (result);
//        }
